...
public class KeyPairApiController implements KeyPairApi	 {
	...
	public ResponseEntity<?> createKeyPair(@ApiParam("Request of create a new keypair ") @Valid @RequestBody KeyPairCreateRequest keyPairCreateRequest) {
	...
	public ResponseEntity<?> generateKeyPair(@ApiParam("Request of generate a new keypair ") @Valid @RequestBody GenerateKeyPairRequest generateKeyPairRequest) {
	...
	public ResponseEntity<?> getKeyPairById(@ApiParam("Id of the keypair to be obtained. Cannot be empty.") @PathVariable(value = "keyPairId") String keyPairId) {
